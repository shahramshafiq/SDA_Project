...
The file `UseCaseDiagram.drawio` contains the UML Use Case Diagram for the INNsight Hotel Booking System. Open it with [draw.io](https://app.diagrams.net/) (File → Open from → Device).
...
| AI Receptionist System | The automated chatbot that handles customer requests |
...
| UC-04 | Modify or Cancel Reservation | Customer | [UC04_ModifyOrCancelReservation.txt](UC04_ModifyOrCancelReservation.txt) |
...
- **Extensions** — alternative or error flows
